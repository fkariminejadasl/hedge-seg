...
class DetrPolylineImageDataset(Dataset):
    ...
    def _lidar_on_padded_grid(self, lidar, H, W):
        ...
        a cell with no woody vegetation has no value at all: 48.4% of cells are
        nodata, but only 7.2% of the cells a hedge passes through, against 51.8%
...
if __name__ == "__main__":
    cfg = dict(
        ...
        exp="3",  # outputs go to save_path/<exp>/, like semseg_unet/<exp>/
