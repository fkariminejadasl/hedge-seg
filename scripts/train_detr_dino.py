"""
Train DETR-style encoder/decoder with Hungarian matching on precomputed DINOv3 embeddings + bounding boxes.

Data: Precomputed DINOv3 patch embeddings paired with ground-truth bounding boxes from LiDAR crops.
Dataset: Generated by hedge_seg.embeddings_and_pack (bounding box variant).
Purpose: DETR baseline with bounding-box regression; precursor to polyline variants.
"""
