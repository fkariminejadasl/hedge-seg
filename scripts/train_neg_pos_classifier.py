"""
Train a linear-probe classifier to validate DINOv3 embeddings on hedgerow presence classification.

Data: Precomputed DINOv3 patch embeddings from LiDAR crops labeled as positive (contains hedgerow) or negative.
Dataset: Generated by scripts/data/build_lidar_training_dataset.py.
Purpose: Sanity check that DINOv3 embeddings encode hedgerow presence; foundation for using DINOv3 in downstream tasks.
"""
