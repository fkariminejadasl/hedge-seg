"""
Train DETR with polyline head on precomputed DINOv3 embeddings from LiDAR crops, optionally with diffusion refinement.
...
Purpose: Direct polyline regression with optional 3-stage diffusion refinement (stage 1 = DETR polyline, stage 2 = diffusion, stage 3 = joint).
Note: Learns polyline distribution but not precise locations; foundational for rel/MapTR variants.
"""
